...
## Facts
- Page: https://tashan.sh/capability/skill-camilooscargbaptista-devops-infra
- tashan id: skill:camilooscargbaptista/devops-infra
...
```sh
cp -r devops-infra ~/.claude/skills/
```
