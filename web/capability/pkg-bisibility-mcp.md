...
## Facts
- Page: https://tashan.sh/capability/pkg-bisibility-mcp
- tashan id: pkg:@bisibility/mcp
...
- npm downloads: 1,054/week
- Official: no

## Install

```sh
claude mcp add bisibility-mcp -- npx -y @bisibility/mcp
```
