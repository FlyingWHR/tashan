...
## Facts
- Page: https://tashan.sh/capability/skill-camilooscargbaptista-observability
- tashan id: skill:camilooscargbaptista/observability
...
```sh
cp -r observability ~/.claude/skills/
```
