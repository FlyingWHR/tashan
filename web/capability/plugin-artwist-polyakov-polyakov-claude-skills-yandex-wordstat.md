...
## Facts
- Page: https://tashan.sh/capability/plugin-artwist-polyakov-polyakov-claude-skills-yandex-wordstat
- tashan id: plugin:artwist-polyakov/polyakov-claude-skills/yandex-wordstat
...
/plugin install yandex-wordstat@polyakov-claude-skills
```
