# Claude Code Feedback · danielrosehill
...
## Facts
- Page: https://tashan.sh/capability/plugin-danielrosehill-claude-code-feedback-claude-code-feedback
...
/plugin install claude-code-feedback@claude-community
```
