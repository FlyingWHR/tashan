...
## Facts
- Page: https://tashan.sh/capability/plugin-nicolasse-ctx-ctx
- tashan id: plugin:nicolasse/ctx/ctx
- Source: https://github.com/nicolasse/ctx
- Type: plugin
- Category: devtools
...
/plugin install ctx@claude-community
```
