...
## Facts
- Page: https://tashan.sh/capability/plugin-artwist-polyakov-polyakov-claude-skills-docx-contracts
- tashan id: plugin:artwist-polyakov/polyakov-claude-skills/docx-contracts
...
/plugin install docx-contracts@polyakov-claude-skills
```
