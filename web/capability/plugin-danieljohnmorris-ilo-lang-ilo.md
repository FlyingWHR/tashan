# Ilo · danieljohnmorris

> Write, run, debug, and explain programs in ilo — a token-optimised programming language for AI agents

## Facts
- Page: https://tashan.sh/capability/plugin-danieljohnmorris-ilo-lang-ilo
