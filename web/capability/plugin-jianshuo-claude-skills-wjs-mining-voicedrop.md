...
## Facts
- Page: https://tashan.sh/capability/plugin-jianshuo-claude-skills-wjs-mining-voicedrop
- tashan id: plugin:jianshuo/claude-skills/wjs-mining-voicedrop
...
/plugin install wjs-mining-voicedrop@claude-skills
```
