...
> React Native/Expo 패턴 - Expo Router, 네이티브 기능, 성능 최적화

## Facts
- Page: https://tashan.sh/capability/plugin-dding-g-ddingg-claude-marketplace-react-native
- tashan id: plugin:dding-g/ddingg-claude-marketplace/react-native
