...
## Facts
- Page: https://tashan.sh/capability/pkg-solmail-mcp
- tashan id: pkg:solmail-mcp
- Source: https://github.com/ExpertVagabond/solmail-mcp
- npm: https://www.npmjs.com/package/solmail-mcp
- Type: npm
- Category: comms
...
```sh
claude mcp add solmail -- npx -y solmail-mcp
```
