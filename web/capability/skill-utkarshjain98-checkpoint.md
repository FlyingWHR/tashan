...
> Create a named git checkpoint (lightweight tag) to save your current state during a session

## Facts
- Page: https://tashan.sh/capability/skill-utkarshjain98-checkpoint
- tashan id: skill:UtkarshJain98/checkpoint
