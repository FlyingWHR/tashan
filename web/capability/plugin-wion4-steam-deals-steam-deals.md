...
## Facts
- Page: https://tashan.sh/capability/plugin-wion4-steam-deals-steam-deals
- tashan id: plugin:wion4/steam-deals/steam-deals
- Source: https://github.com/wion4/steam-deals
- Type: plugin
- Category: other
...
/plugin install steam-deals@claude-community
```
