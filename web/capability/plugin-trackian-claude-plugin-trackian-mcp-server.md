...
## Facts
- Page: https://tashan.sh/capability/plugin-trackian-claude-plugin-trackian-mcp-server
- tashan id: plugin:trackian/claude-plugin/trackian-mcp-server
- Source: https://github.com/trackian/claude-plugin
- Type: plugin
- Category: data
...
/plugin install trackian-mcp-server@claude-community
```
