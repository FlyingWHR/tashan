...
## Facts
- Page: https://tashan.sh/capability/plugin-adnanmir123-ux-superpowers-ux-superpowers
- tashan id: plugin:adnanmir123/ux-superpowers/ux-superpowers
- Source: https://github.com/adnanmir123/ux-superpowers
- Type: plugin
- Category: design
...
/plugin install ux-superpowers@claude-community
```
