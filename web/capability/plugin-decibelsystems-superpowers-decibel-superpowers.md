...
## Facts
- Page: https://tashan.sh/capability/plugin-decibelsystems-superpowers-decibel-superpowers
- tashan id: plugin:decibelsystems/superpowers/decibel-superpowers
- Source: https://github.com/decibelsystems/superpowers
- Type: plugin
- Category: design
...
/plugin install decibel-superpowers@claude-community
```
