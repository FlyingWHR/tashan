# Yandex Metrika · artwist-polyakov

> Аналитика Yandex Metrika: трафик, конверсии, UTM, поисковые системы

## Facts
- Page: https://tashan.sh/capability/plugin-artwist-polyakov-polyakov-claude-skills-yandex-metrika
- tashan id: plugin:artwist-polyakov/polyakov-claude-skills/yandex-metrika
...
/plugin install yandex-metrika@polyakov-claude-skills
```
