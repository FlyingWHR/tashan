...
## Facts
- Page: https://tashan.sh/capability/skill-camilooscargbaptista-kubernetes-review
- tashan id: skill:camilooscargbaptista/kubernetes-review
...
```sh
cp -r kubernetes-review ~/.claude/skills/
```
