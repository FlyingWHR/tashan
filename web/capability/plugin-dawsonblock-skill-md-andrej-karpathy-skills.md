# Andrej Karpathy Skills · dawsonblock
...
## Facts
- Page: https://tashan.sh/capability/plugin-dawsonblock-skill-md-andrej-karpathy-skills
...
```sh
/plugin marketplace add dawsonblock/SKILL-MD
