...
## Facts
- Page: https://tashan.sh/capability/plugin-ahmedraza28-image-generation-skill-image-generation
- tashan id: plugin:ahmedraza28/image-generation-skill/image-generation
- Source: https://github.com/ahmedraza28/image-generation-skill
- Type: plugin
- Category: design
...
/plugin install image-generation@claude-community
```
