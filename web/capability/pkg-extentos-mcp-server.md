...
## Facts
- Page: https://tashan.sh/capability/pkg-extentos-mcp-server
- tashan id: pkg:@extentos/mcp-server
...
- npm downloads: 1,140/week
- Official: no

## Install

```sh
claude mcp add extentos-mcp-server -- npx -y @extentos/mcp-server
```
