...
## Facts
- Page: https://tashan.sh/capability/skill-camilooscargbaptista-event-driven-architecture
- tashan id: skill:camilooscargbaptista/event-driven-architecture
...
```sh
cp -r event-driven-architecture ~/.claude/skills/
```
