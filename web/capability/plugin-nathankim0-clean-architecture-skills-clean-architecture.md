# Clean Architecture · nathankim0

> 클린 아키텍처 원칙에 따라 코드를 리뷰하고 설계 가이드를 제공합니다. 의존성 규칙, SOLID 원칙, 레이어 분리를 검토합니다.

## Facts
- Page: https://tashan.sh/capability/plugin-nathankim0-clean-architecture-skills-clean-architecture
