...
## Facts
- Page: https://tashan.sh/capability/pkg-opentabs-dev-opentabs-plugin-slack
- tashan id: pkg:@opentabs-dev/opentabs-plugin-slack
...
```sh
claude mcp add opentabs-dev-opentabs-plugin-slack -- npx -y @opentabs-dev/opentabs-plugin-slack
```
