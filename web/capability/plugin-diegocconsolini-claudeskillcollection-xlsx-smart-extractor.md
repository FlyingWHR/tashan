...
## Facts
- Page: https://tashan.sh/capability/plugin-diegocconsolini-claudeskillcollection-xlsx-smart-extractor
- tashan id: plugin:diegocconsolini/claudeskillcollection/xlsx-smart-extractor
...
/plugin install xlsx-smart-extractor@security-compliance-marketplace
```
