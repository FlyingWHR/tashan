...
## Facts
- Page: https://tashan.sh/capability/skill-camilooscargbaptista-incident-postmortem
- tashan id: skill:camilooscargbaptista/incident-postmortem
...
```sh
cp -r incident-postmortem ~/.claude/skills/
```
