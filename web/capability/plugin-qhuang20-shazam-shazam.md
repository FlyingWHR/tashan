...
## Facts
- Page: https://tashan.sh/capability/plugin-qhuang20-shazam-shazam
- tashan id: plugin:qhuang20/shazam/shazam
- Source: https://github.com/qhuang20/shazam
- Type: plugin
- Category: devtools
...
/plugin install shazam@claude-community
```
