...
## Facts
- Page: https://tashan.sh/capability/pkg-argus-decision-mcp
- tashan id: pkg:argus-decision-mcp
...
- npm downloads: 3,485/week
- Official: no

## Install

```sh
claude mcp add argus-decision -- npx -y argus-decision-mcp
```
