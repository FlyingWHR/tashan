...
## Facts
- Page: https://tashan.sh/capability/plugin-riwaht-claude-bugbash-bugbash
- tashan id: plugin:riwaht/claude-bugbash/bugbash
- Source: https://github.com/riwaht/claude-bugbash
- Type: plugin
- Category: devtools
...
/plugin install bugbash@claude-community
```
