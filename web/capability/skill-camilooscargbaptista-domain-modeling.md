...
## Facts
- Page: https://tashan.sh/capability/skill-camilooscargbaptista-domain-modeling
- tashan id: skill:camilooscargbaptista/domain-modeling
...
```sh
cp -r domain-modeling ~/.claude/skills/
```
