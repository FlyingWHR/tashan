...
## Facts
- Page: https://tashan.sh/capability/skill-camilooscargbaptista-migration-strategy
- tashan id: skill:camilooscargbaptista/migration-strategy
...
```sh
cp -r migration-strategy ~/.claude/skills/
```
