...
## Facts
- Page: https://tashan.sh/capability/skill-camilooscargbaptista-frontend-review
- tashan id: skill:camilooscargbaptista/frontend-review
...
```sh
cp -r frontend-review ~/.claude/skills/
```
