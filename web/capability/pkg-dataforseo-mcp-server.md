...
## Facts
- Page: https://tashan.sh/capability/pkg-dataforseo-mcp-server
- tashan id: pkg:dataforseo-mcp-server
...
- npm downloads: 4,699/week
- Official: no

## Install

```sh
claude mcp add dataforseo-mcp-server -- npx -y dataforseo-mcp-server
```
