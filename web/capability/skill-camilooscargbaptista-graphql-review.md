...
## Facts
- Page: https://tashan.sh/capability/skill-camilooscargbaptista-graphql-review
- tashan id: skill:camilooscargbaptista/graphql-review
...
```sh
cp -r graphql-review ~/.claude/skills/
```
