...
## Facts
- Page: https://tashan.sh/capability/skill-camilooscargbaptista-database-review
- tashan id: skill:camilooscargbaptista/database-review
...
```sh
cp -r database-review ~/.claude/skills/
```
