...
## Facts
- Page: https://tashan.sh/capability/skill-camilooscargbaptista-engineering-budget
- tashan id: skill:camilooscargbaptista/engineering-budget
...
```sh
cp -r engineering-budget ~/.claude/skills/
```
