...
## Facts
- Page: https://tashan.sh/capability/skill-camilooscargbaptista-developer-experience
- tashan id: skill:camilooscargbaptista/developer-experience
...
```sh
cp -r developer-experience ~/.claude/skills/
```
