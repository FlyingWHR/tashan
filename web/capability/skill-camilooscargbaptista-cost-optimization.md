...
## Facts
- Page: https://tashan.sh/capability/skill-camilooscargbaptista-cost-optimization
- tashan id: skill:camilooscargbaptista/cost-optimization
...
```sh
cp -r cost-optimization ~/.claude/skills/
```
