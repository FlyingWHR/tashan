...
## Facts
- Page: https://tashan.sh/capability/skill-camilooscargbaptista-elixir-review
- tashan id: skill:camilooscargbaptista/elixir-review
...
```sh
cp -r elixir-review ~/.claude/skills/
```
