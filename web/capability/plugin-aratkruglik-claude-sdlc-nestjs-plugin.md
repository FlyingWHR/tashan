...
## Facts
- Page: https://tashan.sh/capability/plugin-aratkruglik-claude-sdlc-nestjs-plugin
- tashan id: plugin:aratkruglik/claude-sdlc/nestjs-plugin
...
/plugin install nestjs-plugin@sdlc-marketplace
```
