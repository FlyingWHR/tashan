...
## Facts
- Page: https://tashan.sh/capability/plugin-dolphinsue319-mcp2plugin-gemini-cli
- tashan id: plugin:dolphinsue319/mcp2plugin/gemini-cli
...
/plugin install gemini-cli@mcp2plugin-marketplace
```
