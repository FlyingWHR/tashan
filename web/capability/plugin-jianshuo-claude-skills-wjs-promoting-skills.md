...
## Facts
- Page: https://tashan.sh/capability/plugin-jianshuo-claude-skills-wjs-promoting-skills
- tashan id: plugin:jianshuo/claude-skills/wjs-promoting-skills
...
/plugin install wjs-promoting-skills@claude-skills
```
