...
| 29 | [Universal DB Client](https://tashan.sh/capability/pkg-izumisy-mcp-universal-db-client.html) | 31 | 17/wk | active |
| 30 | [Snowflake · mikdanjey](https://tashan.sh/capability/pkg-snowflake-mcp-server.html) | 24 | 3k/wk | abandoned |
| 31 | [Postgres](https://tashan.sh/capability/pkg-henkey-postgres-mcp-server.html) | 73 | 2k/wk | active |
| 32 | [Run402](https://tashan.sh/capability/pkg-run402-mcp.html) | 71 | 4k/wk | active |
| 33 | [Read Only Local MySQL](https://tashan.sh/capability/pkg-hovecapital-read-only-mysql-mcp-server.html) | 67 | 203/wk | active |
| 34 | [Mssql](https://tashan.sh/capability/pkg-connorbritain-mssql-mcp-server.html) | 66 | 779/wk | active |
| 35 | [DB Connect](https://tashan.sh/capability/pkg-mcp-db-connect.html) | 66 | 769/wk | active |
| 36 | [PostgreSQL (hardened, read-only)](https://tashan.sh/capability/pkg-postgres-mcp-hardened.html) | 63 | 734/wk | active |
...
| 39 | [SQLite · jparkerweb](https://tashan.sh/capability/pkg-mcp-sqlite.html) | 60 | 896/wk | active |
| 40 | [Ainative Postgres](https://tashan.sh/capability/pkg-ainative-postgres-mcp.html) | 59 | 632/wk | active |
