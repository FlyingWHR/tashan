# What to use for ml engineering

> Training, serving and monitoring models — MLOps, feature stores, drift, ONNX/TensorRT. `model-evaluation` only covers scoring output; a computer-vision or MLOps capability had no home.

Source: https://tashan.sh/task/ml-engineering.html
...
|---|---|---|---|---|
| 1 | [Ollama](https://tashan.sh/capability/pkg-ollama-mcp.html) | 30 | 839/wk | abandoned |
| 2 | [Ollama · hyzhak](https://tashan.sh/capability/pkg-ollama-mcp-server.html) | 21 | 890/wk | abandoned |
| 3 | [Replicate](https://tashan.sh/capability/pkg-replicate-mcp.html) | 28 | 2k/wk | abandoned |
| 4 | [AI Context](https://tashan.sh/capability/pkg-vibgrate-cli.html) | 71 | 3k/wk | active |
| 5 | [Agent Nuvira](https://tashan.sh/capability/pkg-agent-nuvira.html) | 73 | 7k/wk | active |
| 6 | [Gerbil](https://tashan.sh/capability/pkg-tryhamster-gerbil.html) | 69 | 436/wk | active |
| 7 | [Tuning Engines - Governed AI Runtime](https://tashan.sh/capability/pkg-tuningengines-cli.html) | 62 | 241/wk | active |
| 8 | [Gate402](https://tashan.sh/capability/pkg-gate402-mcp.html) | 58 | 234/wk | active |
